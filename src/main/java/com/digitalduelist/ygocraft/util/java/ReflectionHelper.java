...
public class ReflectionHelper
{
	 ...
	 */
	public static <T> Constructor<T> getConstructorAccesseble(Class<T> temp, Class<?>... parameters)
	{
		Constructor<T> constructor = getConstructor(temp, parameters);
	 ...
	 *         requested and makes them accessible.
	 */
	public static <T> Constructor<T> getConstructor(Class<T> temp, Class<?>... parameters)
	{
		try
		{
			Constructor<T> constructor = temp.getDeclaredConstructor(parameters);
			return constructor;
		} catch (NoSuchMethodException e)
		{
			YGOLog.error("There is no constructor for the class : " + temp.toString() + " :");
			return null;
		} catch (SecurityException e)
		{
			YGOLog.error("you can not access the constructor of this class : " + temp.toString() + " :");
			return null;
		}
	}
	...
	public static Method getSpecificMethod(Class<?> temp, String methodName, Class<?>... parameters)
	{
		...
		{
			YGOLog.error("there is no method by this name : " + methodName + " :");
			return null;
		} catch (SecurityException e)
		{
			YGOLog.error("you can not access the method by this name : " + methodName + " :");
			return null;
		}
	}
	...
	public static Field getField(Class<?> temp, String fieldName)
	{
		...
		{
			YGOLog.error("there is no field by this name : " + fieldName + " :");
			return null;
		} catch (SecurityException e)
		{
			YGOLog.error("you can not access the field by this name : " + fieldName + " :");
			return null;
		}
